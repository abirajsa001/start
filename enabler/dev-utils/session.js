...
const getSessionId = async(cartId) => {
  ...
  const sessionMetadata = {
    ...
    allowedPaymentMethods: ["invoice", "prepayment","ideal | Wero","sepa", "ach", "creditcard", "paypal", "onlinebanktransfer", "alipay", "bancontact", "blik", "eps", "mbway", "multibanco", "postfinance", "postfinancecard", "przelewy24", "trustly", "twint", "wechatpay"], // add here your allowed methods for development purposes
  };
